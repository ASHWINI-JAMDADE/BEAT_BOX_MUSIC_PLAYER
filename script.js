...
function setUpdate(){
    ...
    var audioPlayer = new Audio();
       ...
       function playTrack(trackName) {
           ...
           var trackNameWithoutExtension = trackName.split('.')[0];
           document.querySelector('.track-name').textContent = trackNameWithoutExtension;

           document.querySelector('.now-playing').textContent = "PLAYING 1 OF 7"; 
       }
